...
import com.xm.iipp.model.dto.question.QuestionBatchDeleteRequest;
import com.xm.iipp.model.dto.questionBankQuestion.*;
...
public class QuestionBankQuestionController {
    ...
    public BaseResponse<Boolean> removeQuestionBankQuestion(@RequestBody QuestionBankQuestionRemoveRequest questionBankQuestionRemoveRequest) {
        if (questionBankQuestionRemoveRequest == null || questionBankQuestionRemoveRequest.getQuestionBankId() <= 0 || questionBankQuestionRemoveRequest.getQuestionId() <= 0) {
            throw new BusinessException(ErrorCode.PARAMS_ERROR);
        }
        Long questionBankId = questionBankQuestionRemoveRequest.getQuestionBankId();
        Long questionId = questionBankQuestionRemoveRequest.getQuestionId();

        //remove relationship of questionbankid and questionid
